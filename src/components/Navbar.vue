<template>
    <div class="header">
        <div class="header-brand">
            <RouterLink class="link-brand" :to="{ name: 'home' }">
                <svg xmlns="http://www.w3.org/2000/svg" width="" height="25" viewBox="0 0 269 56" fill="none">
                    <path
            ...
            <img @click="toggleItem" 
             class="toggle-menu"
             src="../assets/icons/left-arrow-svgrepo-com.svg" alt=""
